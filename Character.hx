...
class Character extends FlxSprite
{
	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
      ...
      case 'sky':
				// SKY ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/sky_assets');
				frames = tex;
				quickAnimAdd('idle', 'sky idle');
				quickAnimAdd('singUP', 'sky up');
				quickAnimAdd('singRIGHT', 'sky right');
				quickAnimAdd('singDOWN', 'sky down');
				quickAnimAdd('singLEFT', 'sky left');
       ...
       case 'sky-annoyed':
				// SKY ANNOYED ANIMATION LOADING CODE
				tex = Paths.getSparrowAtlas('characters/sky_annoyed_assets');
				frames = tex;
				quickAnimAdd('idle-alt', 'sky annoyed alt idle');
				quickAnimAdd('singUP-alt', 'sky annoyed alt up');
				quickAnimAdd('singRIGHT-alt', 'sky annoyed alt right');
				quickAnimAdd('singDOWN-alt', 'sky annoyed alt down');
				quickAnimAdd('singLEFT-alt', 'sky annoyed alt left');
        quickAnimAdd('idle', 'sky annoyed idle');
				quickAnimAdd('singUP', 'sky annoyed up');
				quickAnimAdd('singRIGHT', 'sky annoyed right');
				quickAnimAdd('singDOWN', 'sky annoyed down');
				quickAnimAdd('singLEFT', 'sky annoyed left');
       	...
       	quickAnimAdd('Huh', 'sky annoyed huh');
       	quickAnimAdd('Oh', 'sky annoyed oh')
       	quickAnimAdd('Ugh', 'sky annoyed ugh')
       	quickAnimAdd('Grr', 'sky annoyed grr')
       	quickAnimAdd('Manifesting', 'sky annoyed manifesting')
       ...
       case 'sky-mad':
				...
				frames = tex;
				quickAnimAdd('idle', 'sky mad idle');
				quickAnimAdd('singUP', 'sky mad up');
				quickAnimAdd('singRIGHT', 'sky mad right');
				quickAnimAdd('singDOWN', 'sky mad down');
				quickAnimAdd('singLEFT', 'sky mad left');
